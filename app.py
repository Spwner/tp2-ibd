...
dados_candidatos_partes = [
    pd.read_csv(f'consulta_cand_2024_BRASIL_{i:02d}.csv', delimiter=';', encoding='iso-8859-1') 
    for i in range(1, 25)
]
...
# Para dados de bens
dados_bens_partes = [
    pd.read_csv(f'bem_candidato_2024_BRASIL_{i:02d}.csv', delimiter=';', encoding='iso-8859-1')
    for i in range(1, 25)
]
...
dados_redes_partes = [
    pd.read_csv(f'rede_social_candidato_2024_BRASIL_{i}.csv', delimiter=';', encoding='iso-8859-1')
    for i in range(1, 9)
]
